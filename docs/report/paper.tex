...
% ACM sigconf format (~8 pages + appendices)
% Compile: pdflatex -> bibtex -> pdflatex -> pdflatex
% Requires: acmart class (TeX Live / Overleaf)
% ============================================================
...
\acmDOI{}
\acmISBN{}
\acmConference[Project report]{Football World Cup MLOps}{May 2026}{Tampere, Finland}
\acmBooktitle{Football World Cup MLOps Project Report}
\acmPrice{}
...
\author{Tom Farnschläder}
\email{tom.farnschlaeder@tuni.fi}
\affiliation{%
...
\author{Sergio Moreschini}
\email{sergio.moreschini@tuni.fi}
\affiliation{%
  \institution{Tampere University}
  \city{Tampere}
  \country{Finland}
...
\keywords{MLOps, football prediction, machine learning pipelines, model lifecycle}
