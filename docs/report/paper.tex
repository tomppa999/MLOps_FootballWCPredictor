...
These shadow refits feed the WC~2026 monitoring leaderboard
(Appendix~\ref{app:model}) so all nine models can be compared on a
like-for-like basis without confounding model family with data recency.
...
Models with fewer than 24 scored matches are skipped to suppress
early-tournament noise.
