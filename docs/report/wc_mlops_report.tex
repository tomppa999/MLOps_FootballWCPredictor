...
\begin{ganttchart}[
  ...
  \ganttbar{Gold (v1, v2)}{2026-03-23}{2026-03-31}%
  \ganttbar{}{2026-04-27}{2026-04-30} \\
...
6~April~2026. Monte Carlo simulation planned for week of 13~April. Gold v2 feature
iteration and monitoring implemented last week of April. Report write-up is ongoing
throughout. First professor meeting: 20~March~2026.}
\label{fig:gantt}
\end{figure*}
...
importance) --- consistent with prior-driven samplers being more receptive
...
noise across most matchups but carries real information when one side
has had a recent training window or tournament and the other has not.
