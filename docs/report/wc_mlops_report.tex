...
6~April~2026. Monte Carlo simulation implemented week of 13~April. Gold v2 feature
iteration and monitoring implemented last week of April. Cloud deployment (Docker,
Cloud Run Jobs, Cloud Scheduler) planned for week of 11~May~2026. Report write-up is
ongoing throughout.}
\label{fig:gantt}
\end{figure*}
